...
<head>
 ...
 <style>
        body{
            ...
            background-image: linear-gradient(to right, rgb(26, 26, 26), rgb(28, 28, 28));
        }
        .box{
            color: white;
            position: absolute;
        ...
        fieldset{
            border: 3px solid #52D681;
        }
        legend{
            border: 1px solid #52D681;
            padding: 10px;
            text-align: center;
    ...
    <div class="box">
        <form action="saveedit.php" method="POST">
            <fieldset>
                ...
                <br><br>
                <div class="inputBox">
                <a href="usuarios.php" id="submit" >Voltar para usuários</a>
    </div>
                <br>
            </fieldset>
        </form>
